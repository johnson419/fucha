      ...
      >
        <div className="flex md:flex-col flex-row gap-10 items-center justify-start max-w-[1123px] mb-[55px] mx-auto w-full">
          ...
          <div className="flex md:flex-1 flex-col justify-start w-1/2 md:w-full">
            <div className="flex flex-row items-start justify-end ml-auto w-[48%] md:w-full">
              <Text
              ...
              <Text
                className="font-medium ml-[49px] mt-1 text-black_900 text-left w-auto"
                variant="body2"
              >
                Log in
              </Text>
            ...
            <div className="flex sm:flex-col flex-row sm:gap-10 items-center justify-between md:ml-[0] ml-[9px] mt-[27px] w-[99%] md:w-full">
              <div className="bg-black_900 flex flex-col gap-[45px] justify-start sm:mt-0 mt-0.5 p-[9px] rounded-[23px] w-[120px] sm:w-full">
                <Img
                  src="images/img_plus.svg"
                  className="h-4 md:ml-[0] ml-[84px] w-4"
                  alt="plus"
                />
                <Text
              ...
              <div className="bg-green_403 flex flex-col gap-[46px] items-end justify-start mb-0.5 p-2 rounded-[23px] w-[120px] sm:w-full">
                <Img
                  src="images/img_plus.svg"
              ...
              <div className="bg-indigo_A200 flex flex-col gap-[45px] items-end justify-start mb-0.5 p-2 rounded-[23px] w-[120px] sm:w-full">
                <Img
                  src="images/img_plus.svg"
                  className="h-4 w-4"
                  alt="plus_Two"
                />
                <Text
                  className="font-bold mb-[11px] text-left text-white_A700"
                  variant="body2"
                >
                  <>
                    Tupe
              ...
              <div
                className="common-pointer bg-blue_400 flex flex-col gap-[59px] justify-start mb-0.5 p-2 rounded-[23px] w-[120px] sm:w-full"
                onClick={() => navigate("/homepage")}
              >
                <Img
                  src="images/img_plus.svg"
                ...
                />
                <Text
                  className="font-bold mb-[11px] ml-1.5 md:ml-[0] mr-[26px] text-left text-white_A700 w-auto"
                  variant="body2"
                >
                  Tufahamu
                </Text>
